...
public class AdversaireDAO extends BaseHibernateDAO {
	...
	// property constants
	public static final String ID_ADVERSAIRE = "idAdversaire";
	...
	public List<Adversaire> findByExample(Adversaire instance) {
		...
		try {
			List<Adversaire> results = (List<Adversaire>) getSession()
					.createCriteria("hiber.Adversaire").add(create(instance))
					.list();
	...
	public List<Adversaire> findByIdAdversaire(Object idAdversaire) {
		return findByProperty(ID_ADVERSAIRE, idAdversaire);
	}
